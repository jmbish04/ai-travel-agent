/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1bf28c40ad73030d96637dd7f323e8b7)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		ENVIRONMENT: "development";
                TRAVEL_AGENT: DurableObjectNamespace /* TravelAgentDO from travel-agent-worker */;
                SCRAPING_AGENT: DurableObjectNamespace /* ScrapingAgentDO from travel-agent-worker */;
                CONVERSATION_MANAGER: DurableObjectNamespace /* ConversationManagerDO from travel-agent-worker */;
                SESSION_MANAGER: DurableObjectNamespace /* SessionManagerDO from travel-agent-worker */;
